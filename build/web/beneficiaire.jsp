		...
		<div class="colorlib-shop">
			<div class="container-fluid">
					...
					<div class="table100-head">
						<%! List<benef>  liste = bnfDB.getAllBenefs();%>
						<table>
							<thead>
								<tr class="row100 head">
									<th class="cell100 column1">num ménage</th>
									<th class="cell100 column1">CIN</th>
									<th class="cell100 column3">Nom</th>
									<th class="cell100 column4">Prénom</th>
									<th class="cell100 column5">nom_pere</th>
									<th class="cell100 column6">nom_mere</th>
									<th class="cell100 column7">test_gro</th>
									<th class="cell100 column7">nombres d'enfants</th>
									<th class="cell100 column7">Observations</th>
                                                                        <th class="cell100 column7">Modifier</th>
							...
							<tbody>
							 <%for (benef p:liste){%>
								<tr class="row100 body">
									<td class="cell100 column1"><%=p.getNum_menage()%></td>
									<td class="cell100 column1"><%=p.getCIN()%></td>
									<td class="cell100 column3"><%=p.getNom()%></td>
									<td class="cell100 column4"><%=p.getPrenom()%></td>
									<td class="cell100 column5"><%=p.getNom_pere()%></td>
									<td class="cell100 column6"><%=p.getNom_mere()%></td>
									<td class="cell100 column7"><%=p.getTest_gro()%></td>
									<td class="cell100 column7"><%=p.getNbr_enfants()%></td>
									<td class="cell100 column7"><%=p.getObservations()%></td>
									<td><a href='editbnf.jsp?num=<%=p.getNum_menage()%>'>Modifier</a></td>
									<td ><a href='../DeleteServletebnf?num=<%=p.getNum_menage()%>'><input type="submit" name="boutons" value="Supprimer" onclick="confirm('Confirmer la suppression de <%=p.getNum_menage()%>')"></a></td>
								</tr>
                                                                  <% }%>
							</tbody>
						</table>
