      ...
      <tr>
       ...
       <%for (benef p:liste){%>
             ...
             <tr>
                      ...
                      <td><%=p.getNom_mere()%></td>
                      <td><%=p.getTest_gro()%></td>
                      <td><%=p.getNbr_enfants()%></td>
                      <td><%=p.getObservations()%></td>
                      <td><%=p.getAdr()%></td>
                                       <td><a href='editbnf.jsp?num=<%=p.getNum_menage()%>'><img src="images/edit.png"  style="width:25px;height:25px;"></a>
                 </td>
                 <td><a href='../DeleteServletebnf?num=<%=p.getNum_menage()%>'><img src="images/off.png"  style="width:25px;height:25px;"></a></td>
