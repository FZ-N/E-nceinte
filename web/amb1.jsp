...
<!--===============================================================================================-->
  ...
  <%}%>
								<h2>Liste des ambulances disponibles</h2>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="colorlib-shop">
						...
						<table>
							<thead>
								<tr class="row100 head">
									...
									<th class="cell100 column3">Etat</th>
									<th class="cell100 column2">Lieu_actuel</th>
									<th class="cell100 column4">Staff_medical</th>
									
									
									<th class="cell100 column7">Date_retour</th>
								</tr>
							</thead>
						</table>
					</div>
					...
					<div class="table100-body js-pscroll">
                        ...
                        if(a.getDisponibilite()== "true"){
                        %>
								<tr class="row100 body">
									<td class="cell100 column1"><%=a.getMatricule()%></td>
									<td class="cell100 column3"><% if (a.getEtat() == "true"){%>
								Good <%} else%> Bad</td>
                                                                        <td class="cell100 column2"><%=a.getLieu_actuel()%></td>
									<td class="cell100 column4"><%=a.getStaff_medical()%></td>
								
								
									<td class="cell100 column7"><%=a.getDate_retour()%></td>
							<%}%><%}%>
								</tr>
