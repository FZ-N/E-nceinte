...
<html>
 ...
 <br><br> <br><br>
        ...
        <form action="ben3.jsp" method = "post">
            <table border="0">
                <tr> 
                    <td><p>CIN : </p>  </td>
            ...
            <c:forEach var = "row" items ="${result.rows}">
                ...
                <c:if test="${row.CIN == bnf.CIN}">
                      ...
                      <tr>
                       ...
                       <td><a href='editbnf.jsp?num=${row.num_menage}'><img src="images/edit.png"  style="width:25px;height:25px;"></a>
                 </td>
                 <td><a href='DeleteServletebnf?num=${row.num_menage}'><img src="images/off.png"  style="width:25px;height:25px;"></a></td>
